...
int execute(char *content, stack_t **top, unsigned int tally, FILE *file);
...
void f_nop(stack_t **top, unsigned int tally);
...
void f_rotl(stack_t **top, unsigned int tally);
...
void f_stack(stack_t **top, unsigned int tally);
#endif
